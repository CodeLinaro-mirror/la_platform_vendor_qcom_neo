...
SECTOOLS_SECURITY_PROFILE := $(QCPATH)/securemsm/security_profiles/aurora_tz_security_profile.xml
...
AB_OTA_UPDATER := true
TARGET_RECOVERY_FSTAB := device/qcom/neo/recovery.fstab
else
TARGET_RECOVERY_FSTAB := device/qcom/neo/recovery_non_AB.fstab
...
BOARD_KERNEL_CMDLINE := video=vfb:640x400,bpp=32,memsize=3072000 printk.devkmsg=on androidboot.hardware=qcom androidboot.memcg=1 androidboot.usbcontroller=a600000.dwc3
...
include device/qcom/wlan/neo/BoardConfigWlan.mk
endif
else
include device/qcom/wlan/neo/BoardConfigWlan.mk
endif
